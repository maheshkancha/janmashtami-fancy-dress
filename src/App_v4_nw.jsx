...
function App() {
  ...
  useEffect(() => {
    ...
    const stormAudio = document.querySelector("#storm-sound");
    const divineAudio = document.querySelector("#divine-sound");
    ...
    const onFound = () => {
      ...
      // Play the atmospheric storm loop immediately upon tracking
      if (stormAudio) {
      ...
      timelineInterval = setInterval(() => {
        ...
        if (elapsedSeconds >= 0 && elapsedSeconds < 4) {
          ...
          // Trigger the divine flute melody track gracefully when Krishna appears
          if (divineAudio && divineAudio.paused) {
            divineAudio.volume = 0.6;
            divineAudio.play().catch((e) => console.log(e));
          }
          ...
          // Fade down the intense storm track as they reach safety
          if (stormAudio) stormAudio.volume = 0.1;
    ...
    const onLost = () => {
      ...
      // Pause audio assets cleanly if tracking snaps off
      if (stormAudio) stormAudio.pause();
      if (divineAudio) {
        divineAudio.pause();
        divineAudio.currentTime = 0; // Reset track to beginning
      }
    };
  ...
  // Separate Lightning Loop bound to storyStep state shifts
  useEffect(() => {
    let lightningInterval = null;
  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative" }}>
      ...
      >
        ...
        <a-assets>
          {/* Loopable Rain & Thunder Ambience Track */}
          <audio id="storm-sound" src="https://google.com" loop></audio>
          {/* Serene Divine Flute Melody Track */}
          <audio id="divine-sound" src="https://google.com" loop></audio>
        </a-assets>
